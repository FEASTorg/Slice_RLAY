<div align="center">
  ...
  <h2><a href="https://github.com/uwo-fast/Slice_RLAY"> Slice RLAY </a></h2>
  <!-- Labels: -->
  <!-- First row: -->
  ...
  <!-- Second row: -->
  <br>
  <a href="https://github.com/uwo-fast/Slice_RLAY/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/uwo-fast/Slice_RLAY" alt="License">
  </a>
  <a href="https://github.com/uwo-fast/Slice_RLAY">
    <img src="https://img.shields.io/github/repo-size/uwo-fast/Slice_RLAY" alt="Repo Size">
  </a>
  <a href="https://github.com/uwo-fast/Slice_RLAY/issues">
    <img src="https://img.shields.io/github/issues/uwo-fast/Slice_RLAY" alt="Issues">
  </a>
  <a href="https://github.com/uwo-fast/Slice_RLAY/network/members">
    <img src="https://img.shields.io/github/forks/uwo-fast/Slice_RLAY?style=social" alt="Forks">
  </a>
  <a href="https://github.com/uwo-fast/Slice_RLAY/stargazers">
    <img src="https://img.shields.io/github/stars/uwo-fast/Slice_RLAY?style=social" alt="Stars">
  </a>
  <!-- Short description: -->
  <h3>4-Channel Relay Slice for BREAD.</h3>
</div>
